...
>
> 本仓自3.0版本后 于2022年12月1日起 已持续更新 ***126*** 次
>
> ***最新更新时间 2023.03.01 16:55 ***


+ ##### 20230301

  * > 优化[Mac端懒人配置](https://raw.githubusercontent.com/xiaomaoJT/QxScript/main/lazy/macOS/QX_XiaoMao.conf)（如遇到mac 开启qx后网页加载缓慢请尝试更新此配置）(本次优化内容主要针对dns及分流优化，涉及配置标签：[dns]、[filter_local]、[filter_remote])。
    >
